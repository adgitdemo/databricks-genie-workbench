---
sidebar_position: 3
description: "Turns scan findings into targeted JSON patches applied via the Genie API."
---
...
- [IQ Scanner](/docs/features/iq-scanner) — produces the findings that feed the Fix Agent
- [Auto-Optimize](/docs/features/auto-optimize) — deeper optimization via benchmarks (independent path)
- [Authentication & Permissions](/docs/platform/authentication) — Fix Agent uses OBO auth
